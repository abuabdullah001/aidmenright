                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active tab-pane">
                                    <form class="form-horizontal" method="post" action="{{Route('partner.update',$partners->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" name="title"
                                                    value="{{$partners->title}}" class="form-control">
                                                @error('name')
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea name="description" class="form-control summernote"
                                                    rows="5">{{$partners->description}}</textarea>
                                                @error('description')
