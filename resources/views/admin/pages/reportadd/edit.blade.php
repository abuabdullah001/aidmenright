                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active tab-pane">
                                    <form class="form-horizontal" method="post" action="{{Route('repo.update',$repo->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" name="name"
                                                    value="{{$repo->name}}" class="form-control">
                                                @error('name')
                                            ...
                                            <div class="col-md-6 form-group">
                                               ...
                                               <input type="file" name="image" value="" class="form-control"> {{$repo->image}}
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea name="description" class="form-control summernote"
                                                    rows="5">{{ $repo->description }}</textarea>
                                                @error('description')
                                            ...
                                            <div class="col-md-6 form-group">
                                                <label for="">PDF</label>
                                                <input type="file" name="pdf" value="" class="form-control"> {{$repo->pdf}}
                                                @error('name')
                                                <div class="error text-red text-bold" style="padding: 0;">
                                                    <strong>
                                                        {{$message}}
